...
## Points clés
- Multi-instances, profils séparés
- Accès facile aux versions PvP (1.8.9) et moderne (1.20+)
- Préparation pour packs Fabric/Quilt (Sodium, Lithium, etc.)

## Avertissement légal
- Ce projet n’est pas affilié à Mojang/Microsoft.
- N’intègre aucun fichier Minecraft et n’altère pas la connexion Microsoft.
